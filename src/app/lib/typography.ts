...
export const FS_DISPLAY_MOBILE  = "clamp(2.25rem, 9vw, 2.75rem)";   
export const FS_DISPLAY_TABLET  = "clamp(3rem, 6.5vw, 4rem)";       
export const FS_DISPLAY_DESKTOP = "clamp(3.25rem, 4.4vw, 4.5rem)";  
