...
│       ├── PillarsSection.tsx     # 3 pillars + dark stats strip (413 lines)
...
3. **PillarsSection** — 3 pillars (Struktur, Nəzarət, İnkişaf) + dark stats strip
4. **ServicesSection** — 8 service cards grid + CTA with CtaSitting figure
5. **WhyUsSection** — sticky scroll, 5 advantages, 300vh tall
6. **PartnerSection** — PLH Hüquq Bürosu partnership
7. **ClientsSection** — client logos
8. **Footer**
